...
| `pgsync.sync`                    | Inside pull or on_publish  | Build queries, fetch rows from PG, transform to docs (generator). Tags: `table`, `filter_size`. (Scope and duration are in logs.) |
